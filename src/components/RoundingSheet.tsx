        ...
        <table className="w-full border-collapse bg-white overflow-hidden">
          <thead>
            <tr className="text-gray-900 text-[10px] font-bold" style={{ backgroundColor: COLORS.mint }}>
              <th className="p-1 text-left sticky left-0 z-10 w-[100px]" style={{ backgroundColor: COLORS.mint, borderRight: NEO_BORDER, borderBottom: NEO_BORDER }}>Patient</th>
              <th className="p-1 text-left w-[70px]" style={{ borderRight: '1px solid #000', borderBottom: NEO_BORDER }}>Loc</th>
              <th className="p-1 text-left w-[50px]" style={{ borderRight: '1px solid #000', borderBottom: NEO_BORDER }}>Code</th>
              <th className="p-1 text-left w-[120px]" style={{ borderRight: '1px solid #000', borderBottom: NEO_BORDER }}>Problems</th>
              <th className="p-1 text-left w-[140px]" style={{ borderRight: '1px solid #000', borderBottom: NEO_BORDER }}>Diagnostics</th>
              <th className="p-1 text-left w-[140px]" style={{ borderRight: '1px solid #000', borderBottom: NEO_BORDER }}>Therapeutics</th>
              <th className="p-1 text-left w-[50px]" style={{ borderRight: '1px solid #000', borderBottom: NEO_BORDER }}>IVC</th>
              <th className="p-1 text-left w-[55px]" style={{ borderRight: '1px solid #000', borderBottom: NEO_BORDER }}>Fluids</th>
              <th className="p-1 text-left w-[55px]" style={{ borderRight: '1px solid #000', borderBottom: NEO_BORDER }}>CRI</th>
              <th className="p-1 text-left w-[120px]" style={{ borderRight: '1px solid #000', borderBottom: NEO_BORDER }}>Concerns</th>
              <th className="p-1 text-center sticky right-0 z-10 w-[60px]" style={{ backgroundColor: COLORS.mint, borderLeft: NEO_BORDER, borderBottom: NEO_BORDER }}>Save</th>
            </tr>
          </thead>
          <tbody>
                ...
                <tr key={patient.id} style={{ backgroundColor: rowBg }}>
                  ...
                  <td className="p-0.5" style={{ borderRight: '1px solid #ccc', borderBottom: '1px solid #ccc' }}>
                    <select
                      ...
                      className="w-full px-1 py-0.5 text-xs rounded bg-gray-50 focus:outline-none focus:ring-1 focus:ring-[#6BB89D]"
                  ...
                  <td className="p-0.5" style={{ borderRight: '1px solid #ccc', borderBottom: '1px solid #ccc' }}>
                    <select
                      ...
                      style={{
                        ...
                        backgroundColor: data.code === 'Green' ? '#D1FAE5' : data.code === 'Yellow' ? '#FEF3C7' : data.code === 'Orange' ? '#FFEDD5' : data.code === 'Red' ? '#FEE2E2' : undefined
                      }}
                    >
                      <option value="">-</option>
                  ...
                  <td className="p-0.5" style={{ borderRight: '1px solid #ccc', borderBottom: '1px solid #ccc' }}>
                    <textarea
                      ...
                      rows={2}
                      className="w-full px-1 py-0.5 text-xs rounded bg-gray-50 focus:outline-none focus:ring-1 focus:ring-[#6BB89D] resize-none"
                      style={{ border: '1px solid #ccc' }}
                    />
                  </td>
                  {/* Diagnostics */}
                  ...
                  <td className="p-0.5" style={{ borderRight: '1px solid #ccc', borderBottom: '1px solid #ccc' }}>
                    <select
                      ...
                      className="w-full px-0.5 py-0.5 text-xs rounded bg-gray-50 focus:outline-none focus:ring-1 focus:ring-[#6BB89D]"
                      style={{ border: '1px solid #ccc' }}
                    >
                      <option value="">-</option>
                  ...
                  <td className="p-1 text-center sticky right-0 z-10" style={{ backgroundColor: rowBg, borderLeft: NEO_BORDER, borderBottom: '1px solid #000' }}>
                    <button
                      ...
                      className="px-2 py-1 rounded text-[10px] font-bold transition hover:-translate-y-0.5 disabled:opacity-30 text-gray-900"
                      style={{ backgroundColor: hasChanges ? COLORS.mint : '#E5E7EB', border: '1px solid #000' }}
                    >
                      {hasChanges ? 'Save' : 'OK'}
                    </button>
                  </td>
