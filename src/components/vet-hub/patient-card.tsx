...
import { Trash2, Clock, ChevronsUpDown, ChevronUp, ChevronDown } from 'lucide-react';
...
const PatientCard: React.FC<PatientCardProps> = ({ patient, isCollapsed, onToggleCollapse, onRemove, ...props }) => {
  ...
  return (
    <Collapsible
      asChild
      open={!isCollapsed}
      onOpenChange={() => onToggleCollapse(patient.id)}
    >
        ...
        <CardHeader>
          <div className="flex justify-between items-start">
            <div className="flex-1">
              <div className="flex items-center gap-3 mb-2 flex-wrap">
                <CollapsibleTrigger asChild>
                    <Button variant="ghost" size="icon" className="h-8 w-8">
                        ...
                        <span className="sr-only">Toggle Patient Card</span>
                    </Button>
                </CollapsibleTrigger>
              ...
              {total > 0 && (
                <div className="flex items-center gap-3 max-w-sm ml-12">
